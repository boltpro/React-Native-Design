...
class MyCommunitiesController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getData() {
        ...
        var request = URLRequest(url: URL(string: Constants.METHOD_GROUP_GET_MY_GROUPS)!, cachePolicy: .reloadIgnoringLocalCacheData, timeoutInterval: 60)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.addonLabel.text = NSLocalizedString("label_followers", comment: "") + ": " + String(item.getFollowersCount());
