...
class MessagesController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var with_android_msg_fcm_regid = ""
    var with_ios_msg_fcm_regid = ""
    ...
    func getData() {
        ...
        let postString = "clientId=" + String(Constants.CLIENT_ID) + "&accountId=" + String(iApp.sharedInstance.getId()) + "&accessToken=" + iApp.sharedInstance.getAccessToken() + "&messageCreateAt=" + String(itemId);
