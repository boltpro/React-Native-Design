...
class BalanceController: UIViewController, SKProductsRequestDelegate, SKPaymentTransactionObserver, GADRewardBasedVideoAdDelegate {
    ...
    let COINS_PRODUCT_LOW = "ru.ifsoft.mynetwork.low" // ru.ifsoft.mynetwork.low
    
    let COINS_PRODUCT_NORMAL = "ru.ifsoft.mynetwork.normal" // ru.ifsoft.mynetwork.normal
    
    let COINS_PRODUCT_HIGHT = "ru.ifsoft.mynetwork.hight" // ru.ifsoft.mynetwork.hight
    ...
    override func viewDidLoad() {
        ...
        rewardBasedVideo.load(GADRequest(), withAdUnitID: NSLocalizedString("admob_rewarded_id", comment: ""));
    }
            ...
            if let trans = transaction as? SKPaymentTransaction {
                ...
                case .purchased:
                    ...
                    if (productID == COINS_PRODUCT_LOW) {
                        ...
                        self.payment(cost: LOW, amount: 1, paymentType: Constants.PT_APPLE_PURCHASE);
                        ...
                        self.payment(cost: HIGHT, amount: 3, paymentType: Constants.PT_APPLE_PURCHASE);
                    }
    ...
    func rewardBasedVideoAdDidClose(_ rewardBasedVideoAd: GADRewardBasedVideoAd) {
        ...
        GADRewardBasedVideoAd.sharedInstance().load(GADRequest(), withAdUnitID: NSLocalizedString("admob_rewarded_id", comment: ""))
    }
