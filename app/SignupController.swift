...
class SignupController: UIViewController, UITextFieldDelegate, LoginButtonDelegate {
    ...
    func signup(username: String, fullname: String, password: String, email: String) {
        ...
        let postString = "clientId=" + String(Constants.CLIENT_ID) + "&username=" + username + "&fullname=" + fullname + "&password=" + password + "&email=" + email + "&fcm_regId=" + iApp.sharedInstance.getFcmRegId() + "&appType=" + String(Constants.APP_TYPE_IOS) + "&lang=en" + "&facebookId=" + iApp.sharedInstance.getFacebookId();
